function triggerTreeAnimation() {
	...
	var tl = new TimelineMax({ repeat: -1 })
		.to([".flowers__dot1", ".flowers__dot2", ".flowers__dot3"], 2, {
			opacity: 0.1,
			ease: Power0.easeOut
		})
		.to([".flowers__dot1", ".flowers__dot2", ".flowers__dot3"], 2, {
	...
	var bee1 = new TimelineMax({ repeat: -1 })
		...
		.to(".bees__1", 1, { left: "+=60px", rotation: -180, ease: Power0.easeNone });
	...
	var bee3 = new TimelineMax({ repeat: -1 }).to(".bees__3", 10, {
		bezier: {
			type: "curviness:1.25",
			values: [
				{ x: 0, y: 0 },
	...
	var bird_tail = new TimelineMax({ repeat: -1 }).to(".bird__tail", 2, {
		rotationX: 60,
		ease: Circ.easeInOut,
		yoyo: true,
		repeat: -1
